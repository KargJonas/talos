...
DEBROADCASTING_BINARY_OP(add_dbrc, =, a + b)
DEBROADCASTING_BINARY_OP(add_dbrc_acc, +=, a + b)

DEBROADCASTING_BINARY_OP(sub_dbrc, =, a - b)
DEBROADCASTING_BINARY_OP(sub_dbrc_acc, +=, a - b)

DEBROADCASTING_BINARY_OP(mul_dbrc, =, a * b)
DEBROADCASTING_BINARY_OP(mul_dbrc_acc, +=, a * b)

DEBROADCASTING_BINARY_OP(div_dbrc, =, a / b)
DEBROADCASTING_BINARY_OP(div_dbrc_acc, +=, a / b)

DEBROADCASTING_BINARY_OP(pow_dbrc, =, pow(a, b))
DEBROADCASTING_BINARY_OP(pow_dbrc_acc, +=, pow(a, b))
