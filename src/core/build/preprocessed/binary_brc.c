...
BROADCASTING_BINARY_OP(add_brc, =, a + b)
BROADCASTING_BINARY_OP(add_brc_acc, +=, a + b)

BROADCASTING_BINARY_OP(sub_brc, =, a - b)
BROADCASTING_BINARY_OP(sub_brc_acc, +=, a - b)

BROADCASTING_BINARY_OP(mul_brc, =, a * b)
BROADCASTING_BINARY_OP(mul_brc_acc, +=, a * b)

BROADCASTING_BINARY_OP(div_brc, =, a / b)
BROADCASTING_BINARY_OP(div_brc_acc, +=, a / b)

BROADCASTING_BINARY_OP(pow_brc, =, pow(a, b))
BROADCASTING_BINARY_OP(pow_brc_acc, +=, pow(a, b))
